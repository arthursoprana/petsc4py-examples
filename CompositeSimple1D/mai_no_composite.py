...
options.setValue('-ts_theta_theta', 1.0)
...
# options.setValue('-ts_max_snes_failures', -3)
...
# options.setValue('-snes_composite_type', 'multiplicative')
...
# time_intervals = [0.10785]
# time_intervals = np.linspace(0,250, num=250)
time_intervals = np.linspace(0,250, num=100)
